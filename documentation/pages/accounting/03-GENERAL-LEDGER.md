...
### Expenses Manager → General Ledger
When an expense is paid:
```
POST /api/v1/general_ledger/entries
{
  account_id: "5300", // Office Supplies
  transaction_type: "payment",
  contact_name: "ABC Vendor",
...
*The General Ledger is the foundation of the accounting system. All financial transactions flow through this module.*
