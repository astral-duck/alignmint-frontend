...
- **[Project Guide](documentation/PROJECT-GUIDE.md)** - Product vision and requirements
- **[Technical Spec](documentation/backend/rails/TECHNICAL-SPEC.md)** - Complete Rails specifications
- **[Data Schema](documentation/backend/shared/01-DATA-SCHEMA.md)** - Database schema (28+ tables)
- **[Database SQL](documentation/database/DATABASE-SCHEMA.sql)** - PostgreSQL CREATE statements
- **[API Requirements](documentation/backend/shared/02-API-REQUIREMENTS.md)** - ~180+ API endpoints
- **[User Roles & Permissions](documentation/backend/shared/04-USER-ROLES-AND-PERMISSIONS.md)** - 4-role RBAC system
- **[Page Documentation](documentation/pages/)** - 50+ detailed component docs
- **[Deployment Guide](documentation/deployment/DEPLOYMENT-GUIDE.md)** - Production deployment
...
│   ├── backend/           # Backend specifications and documentation
│   │   ├── rails/         # Rails specifications
│   │   ├── shared/        # Shared backend documentation
│   │   └── ...
...
### Backend Integration
See `documentation/backend/rails/TECHNICAL-SPEC.md` for backend specifications and `documentation/PROJECT-GUIDE.md` for the integration roadmap.
